...
simplify_time_periods <- function(lsoa_bustrips) {
...
make_simplified_bustrips_lsoa21_single_year <- function(data_year) {

  # get single years worth of bus data
  lsoa21_bustrips <- load_lsoa21_bustrips(data_year)
  # simplify
  lsoa21_bustrips_simplified <- simplify_time_periods(lsoa21_bustrips)
