...
stops_2004_count = gtfs_stop_frequency(gtfs_2004,
                               startdate = lubridate::ymd("2004-10-01"),
                               enddate = lubridate::ymd("2004-10-31"))
stops_2005_count = gtfs_stop_frequency(gtfs_2005,
                               startdate = lubridate::ymd("2005-10-01"),
                               enddate = lubridate::ymd("2005-10-31"))
stops_2006_count = gtfs_stop_frequency(gtfs_2006,
                               startdate = lubridate::ymd("2006-10-01"),
                               enddate = lubridate::ymd("2006-10-31"))
stops_2007_count = gtfs_stop_frequency(gtfs_2007,
                               startdate = lubridate::ymd("2007-10-01"),
                               enddate = lubridate::ymd("2007-10-31"))
stops_2008_count = gtfs_stop_frequency(gtfs_2008,
                               startdate = lubridate::ymd("2008-10-01"),
                               enddate = lubridate::ymd("2008-10-31"))
stops_2009_count = gtfs_stop_frequency(gtfs_2009,
